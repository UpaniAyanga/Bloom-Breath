  ...
  return (
    <article className="rounded-2xl border border-[#E4E2DA] bg-[#FDFBF7] p-4 shadow-[0_6px_18px_rgba(131,140,127,0.12)]">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="text-base font-medium tracking-[0.01em] text-[#50594C]">{technique.name}</h3>
          <p className="mt-1 text-xs leading-relaxed text-[#7E857B]">{technique.description}</p>
        </div>
        {technique.isCustom && (
